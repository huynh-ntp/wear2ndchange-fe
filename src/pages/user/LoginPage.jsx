...
const LoginPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (isLogin) {
        ...
        // Navigate back to the page user came from, or home if no previous page
  ...
  useEffect(() => {
    if (user) {
      // Navigate to the page user came from, or home page if no previous page
      const from = location.state?.from?.pathname || "/";
      navigate(from, { replace: true });
    }
        ...
        <DialogContent>
          {forgotPasswordSuccess ? (
            ...
            <>
              <Typography
                variant="body2"
                sx={{ mb: 2, color: "#333", fontSize: "14px" }}
              >
